...
I led the team that defined blueprint standards, including standard template, language, and image guidelines. I personally edited numerous blueprints, including those listed below.

**Outcome:** Enable software developers to build complex solutions on a cloud platform
...
I led the initiative to build a new Announcements space on the Genesys Cloud Resource Center. I worked with my executive sponsor to define requirements and then coordinated with the Release Documentation Coordinator, UX Researches, UX Designers, and Documentation Engineering to design the site architecture and functionality. After launch, I ensured smooth operations and regular updates to this highly visible space.  
...
- **Start with the user journey:** what someone is trying to accomplish and where they get stuck  
- **Design the structure:** clear nav, consistent templates, predictable naming  
- **Write for skimming:** headings that answer questions, short sections, examples early  
- **Make it maintainable:** docs-as-code when appropriate, lightweight governance, review workflows
